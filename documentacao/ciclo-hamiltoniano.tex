...
\author{Seu Nome\\ Instituto Federal de Educação, Ciência e Tecnologia da Paraíba\\ Campus Santa Rita\\ Curso de Análise e Desenvolvimento de Sistemas\\ \texttt{seu.email@ifpb.edu.br}}
\date{Dezembro 2025}
...
\begin{enumerate}
  \item \textbf{Instâncias Fáceis}: Tempo praticamente linear em relação a $n$, pois o algoritmo encontra uma solução rapidamente sem necessidade de exploração extensiva \cite{Kleimberg2005}.
...
A seguir apresenta-se a implementação completa e comentada em Java para o problema do Ciclo Hamiltoniano com suporte a medição de desempenho, baseada nas recomendações de Cormen et al. \cite{Cormen2012}. Este código foi utilizado para os testes apresentados neste relatório.
...
O código completo está disponível em repositório GitHub. Para compilar e executar:
